...
class Fish extends Pet {
    Fish(String species, String nickname, int age, int trickLevel, String[] arrayHabits) {
        super();
...
class DomesticCat extends Pet {
    DomesticCat(String species, String nickname, int age, int trickLevel, String[] arrayHabits) {
        super();
        this.species = species;
        this.nickname = nickname;
        this.age = age;
...
class Dog extends Pet {
    Dog(String species, String nickname, int age, int trickLevel, String[] arrayHabits) {
        super();
        this.species = species;
        this.nickname = nickname;
        this.age = age;
...
class RoboCat extends Pet {
    RoboCat(String species, String nickname, int age, int trickLevel, String[] arrayHabits) {
        super();
        this.species = species;
        this.nickname = nickname;
        this.age = age;
