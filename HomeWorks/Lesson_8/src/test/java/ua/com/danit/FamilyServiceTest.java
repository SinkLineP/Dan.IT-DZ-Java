...
public class FamilyServiceTest {
    ...
    public void bornChild() {
        ...
        switch (randomValue) {
            case 0:
                ...
                assertEquals("Family { mother='Woman1 Surname1', father='Father1 Surname1', childrens=[[Name: girlName, surname: Surname1, year: 2021, schedule: {WEDNESDAY=Go to travel, MONDAY=Go to school, THURSDAY=Home working, SUNDAY=Sleep, TUESDAY=Go to shop, FRIDAY=Walk, SATURDAY=Sleep}]]}", family.toString());
                break;
            case 1:
                boy = new Man("manName", surname, year);
                family.addChild(boy);
                assertEquals("Family { mother='Woman1 Surname1', father='Father1 Surname1', childrens=[[Name: manName, surname: Surname1, year: 2021, schedule: {WEDNESDAY=Go to travel, MONDAY=Go to school, THURSDAY=Home working, SUNDAY=Sleep, TUESDAY=Go to shop, FRIDAY=Walk, SATURDAY=Sleep}]]}", family.toString());
                break;
        }
        System.out.println();
    ...
    public void adoptChild() {
        children1 = new Children("Children1", "Surname1", 2013);
        family.addChild(children1);
        assertEquals("Family { mother='Woman1 Surname1', father='Father1 Surname1', childrens=[[Name: Children1, surname: Surname1, year: 2013, schedule: {WEDNESDAY=Go to travel, MONDAY=Go to school, THURSDAY=Home working, SUNDAY=Sleep, TUESDAY=Go to shop, FRIDAY=Walk, SATURDAY=Sleep}]]}", family.toString());
    ...
    public void deleteAllChildrenOlderThen() {
        ...
        for (int i = 0; i < family.childrens.size(); i++) {
            if (currentYear - family.childrens.get(i).year > age) {
                family.childrens.remove(i);
                System.out.println("Child deleted from family!");
                assertEquals("Family { mother='Woman1 Surname1', father='Father1 Surname1', childrens=[[Name: Children2, surname: Surname2, year: 2019, schedule: {WEDNESDAY=Go to travel, MONDAY=Go to school, THURSDAY=Home working, SUNDAY=Sleep, TUESDAY=Go to shop, FRIDAY=Walk, SATURDAY=Sleep}]]}", family.toString());
            } else {
                assertEquals("Family { mother='Woman1 Surname1', father='Father1 Surname1', childrens=[" +
                        "[" +
                        "Name: Children1, surname: Surname1, year: 2013, schedule: {WEDNESDAY=Go to travel, MONDAY=Go to school, THURSDAY=Home working, SUNDAY=Sleep, TUESDAY=Go to shop, FRIDAY=Walk, SATURDAY=Sleep}, " +
                        "Name: Children2, surname: Surname2, year: 2019, schedule: {WEDNESDAY=Go to travel, MONDAY=Go to school, THURSDAY=Home working, SUNDAY=Sleep, TUESDAY=Go to shop, FRIDAY=Walk, SATURDAY=Sleep}" +
                        "]]}", family.toString());
